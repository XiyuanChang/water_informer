...
for id, test_df in test_dfs.items():
    ...
    #     r2_dict[id] = full_pbias.numpy()
    #     pbias_dict[id] = full_r2.numpy()
    #     continue
...
metric_df.to_csv("wrtdsC_metric.csv", index=False, na_rep='')
...
# with open("wrtdsC_result.json", "w") as f:
#     import json
#     d = {
#         "NSE": nse_list,
#         "R2": r2_list,
...
# with open("wrtdsC_result.txt", "w") as f:
